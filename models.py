...
class Authors(models.Model):
    ...
    card = models.ForeignKey('Card', related_name='authors')
...
class Card(models.Model):
    ...
    is_certified = models.NullBooleanField(verbose_name=_('Card was certified'))
...
class Image(models.Model):
    ...
    description = models.TextField(_('Description'), blank=True)
    card = models.ForeignKey('Card', related_name='image_gallery')
...
class YoutubeEmbed(models.Model):
    ...
    card = models.ForeignKey('Card', related_name='youtube_embeds')
